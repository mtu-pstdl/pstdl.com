...
export const members: Member[] = [
	{
		...
		type: MemberType.MS,
		bio: "Austen Goddu is a 5th year Computer Engineering student here at Michigan Tech. Austen joined the Planetary Surface Technology Development Lab after spending several years on the leadership team in Michigan Tech's Aerospace Enterprise. There, Austen gained experience in SystMemberType.MS Engineering and Flight Software Design. Working on the L-SABRE development team, Austen works to design and build L-SABRE's computer system and flight software, assists with the systMemberType.MS engineering and mission design, and perfoMemberType.MS testing of specific elements of customer hardware.",
	...
	},
	{
		...
		major: MemberMajor.ME,
		type: MemberType.PHD,
		bio: "Marcello Guadagno (Chell) has a Bachelor's inMemberMajor.ME with minors in Aerospace Engineering, Electrical Engineering, and International Leadership (MTU 2019). He has 5 years of end-to-end space mission engineering and program management experience. During his undergrad, Marcello led the development of several smallsat missions while at Michigan Tech and worked on the OCULUS-ASR mission launched in 2019. He has previously worked at the Space Dynamics Laboratory and NASA as a Guidance, Navigation & Control systMemberType.MS engineer. Marcello began his work in the PSTDL in the Spring of 2020. His graduate work focuses on developing In-Situ Lunar robotic mining missions.",
	...
	},
	{
		...
		major: MemberMajor.ME,
		type: MemberType.PHD,
		bio: "Travis Wavrunek completed his B.S. inMemberMajor.ME at Michigan Tech in Spring 2020 and joined the PSTDL lab the following summer. His work focuses on creating a gravity offloading system for rover testing in the lunar sandbox as well as thermal modeling of the L-SABRE.",
